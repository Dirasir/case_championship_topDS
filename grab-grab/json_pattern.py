def into_json(company_id, name, city, address, website, ypage, rating, phones, categories, reviews, goods, opening_hours, count_of_reviews=0):
    """ Шаблон файла OUTPUT.json"""
    if count_of_reviews == 0: count_of_reviews = len(reviews)
    data_grabbed = {
